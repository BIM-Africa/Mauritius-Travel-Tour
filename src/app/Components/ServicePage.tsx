 ...
 absolute z-[2]
  ...
  />
          ...
          <div className="self-center md:pl-8">
            ...
            <p className="text-white leading-5">
              At the Island Ride, every journey is more than just a ride - it's an experience of care, comfort, and
              convenience. Whether you're discovering Maurituis for the first time or commuting as a local, our mordern fleet and professional chauffeurs ensure  you travel saftely and
              in style. From airport to private tours and daily commutes, we're dedicated to making every mile memorable.
              {aboutOpen && (
                <>
                  {" "}
                   Our
